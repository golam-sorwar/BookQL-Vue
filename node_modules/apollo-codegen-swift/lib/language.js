...
class SwiftGenerator extends CodeGenerator_1.default {
    ...
    structDeclaration({ structName, description, adoptedProtocols = [], namespace = undefined }, closure) {
        this.printNewlineIfNeeded();
        this.comment(description);
        const isRedundant = adoptedProtocols.includes("GraphQLFragment") && !!namespace;
        const modifier = isRedundant ? "" : "public ";
        this.printOnNewline(`${modifier}struct ${escapeIdentifierIfNeeded(structName)}`);
